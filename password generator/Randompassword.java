...
public class Randompassword{
    ...
    public static void generatePassword(int length) {
        ...
        try{
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/password?characterEncoding=latin1","root","");

            System.out.println("connected");
            System.out.println(generatepassword);

            String sql = "INSERT INTO passwordgenerator VALUES (?)";
